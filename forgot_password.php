  ...
  if(isset($_POST["submit"])){    
    ...
    if($error["emailFieldError"] == ""){
      ...
      if($affectedRows){        
        ...
        $mail->Body = <<<END
            Click <a href="http://localhost/Capstone_System/reset_password.php?token=$token">here</a> to reset your password. Please ignore if you didn't request this. Thank you!
        END;
    ...
    <section class="flex p-3" id="login-header" >
      ...
      <section id="login" class="card p-3">
        ...
        <div class="top-header flex-column">          
          <h1 class="txt-lg my-2">Forgot Password</h1>          
        </div>
